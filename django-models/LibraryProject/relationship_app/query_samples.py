...
books_by_author = Book.objects.filter(author__name='test')
for book in books_by_author:
    print(f"Book: {book.title}")

print("\n=== List all books in a library ===")
# List all books in a library.
library_instance = Library.objects.get(name='anas')
...
print("\n=== Retrieve the librarian for a library ===")
# Retrieve the librarian for a library.
library_for_librarian = Library.objects.get(name='casa')
